...
type FactoryUserLog struct {
	...
	UserId *preform.ForeignKey[int64] `db:"user_id" json:"UserId" dataType:"INTEGER"`
	RelatedLogId *preform.ForeignKey[preformTypes.Null[int64]] `db:"related_log_id" json:"RelatedLogId" dataType:"INTEGER"`
	Type *preform.Column[int64] `db:"type" json:"Type" dataType:"INTEGER"`
	Detail *preform.Column[preformTypes.JsonRaw[interface {}]] `db:"detail" json:"Detail" dataType:"jsonb"`
...
func (f FactoryUserLog) CloneInstance(factory preform.IFactory) preform.IFactory {
	...
	ff.UserId = cols[1].(*preform.ForeignKey[int64] )
	ff.RelatedLogId = cols[2].(*preform.ForeignKey[preformTypes.Null[int64]] )
	ff.Type = cols[3].(*preform.Column[int64] )
	ff.Detail = cols[4].(*preform.Column[preformTypes.JsonRaw[interface {}]] )
...
type UserLogBody struct {
	...
	UserId int64 `db:"user_id" json:"UserId" dataType:"INTEGER"`
	RelatedLogId preformTypes.Null[int64] `db:"related_log_id" json:"RelatedLogId" dataType:"INTEGER"`
	Type int64 `db:"type" json:"Type" dataType:"INTEGER"`
	Detail preformTypes.JsonRaw[interface {}] `db:"detail" json:"Detail" dataType:"jsonb"`
