...
func (f FactoryUserLog) CloneInstance(factory preform.IFactory) preform.IFactory {
	...
	ff.RelatedLogId = cols[2].(*preform.ForeignKey[preformTypes.Null[uuid.UUID]] )
	ff.Type = cols[3].(*preform.Column[PreformTestALogType] )
	ff.Detail = cols[4].(*preform.Column[PreformTestALogDetail] )
