...
func (d postgresqlDialect) ArrayEq(arrColA any, arrColB any) (query string, args []any, err error) {
	return d.arrayFormatter(arrColA, arrColB, "%s = %s")
}

func (d postgresqlDialect) ArrayConcat(arrColA any, arrColB any) (query string, args []any, err error) {
	return d.arrayFormatter(arrColA, arrColB, "%s || %s")
}
func (d postgresqlDialect) ArrayContains(arrColA any, arrColB any) (query string, args []any, err error) {
	return d.arrayFormatter(arrColA, arrColB, "%s @> %s")
}
func (d postgresqlDialect) ArrayContainsBy(arrColA any, arrColB any) (query string, args []any, err error) {
	return d.arrayFormatter(arrColA, arrColB, "%s <@ %s")
}

func (d postgresqlDialect) ArrayAny(arrCol any, value any) (query string, args []any, err error) {
	return d.arrayFormatter(value, arrCol, "%s = ANY(%s)")
}

func (d postgresqlDialect) ArrayHasAny(arrColA any, arrColB any) (query string, args []any, err error) {
	return d.arrayFormatter(arrColA, arrColB, "%s && %s")
}

func (d postgresqlDialect) arrayFormatter(v1 any, v2 any, format string) (query string, args []any, err error) {
