module github.com/go-preform/preform/benchmark

go 1.21

toolchain go1.21.6

replace github.com/go-preform/preform => ../

require (
	github.com/go-preform/preform v0.1.0
...
require (
	...
	github.com/go-preform/squirrel v1.5.4-faster // indirect
